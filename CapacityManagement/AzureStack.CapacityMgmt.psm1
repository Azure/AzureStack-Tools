...
function Get-ManagedDiskCapacityOnVolume {
    param (
    ...
    $QueryVolume = Prepare-MigrationSource -VolumeLabel $VolumeLabel
...
function Prepare-MigrationSource {
    param (
...
function Get-UnattachedDisks {
    ...
    $MigrationSource = Prepare-MigrationSource -VolumeLabel $VolumeLabel
...
function Import-DiskMigrationCandidates {
    param (
