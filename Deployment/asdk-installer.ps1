...
From: Michela Sainato 
Sent: Thursday, August 9, 2018 2:43 PM
To: Siddique Juman <sijuman@microsoft.com>; Ricardo Mendes <ricardom@microsoft.com>
Subject: FW: Azure Stack integration with Azure Gov release (8/13) 

Hi Siddique, 

I would need your help. This is a simple ask. 

Here the new script, where as Wassim suggested I insert the changes. 

Please, can you please help me on validate it first, then publish it on Github and explain how to do it ? Here where to update it:https://github.com/Azure/AzureStack-Tools/blob/master/Deployment/asdk-installer.ps1

@Ricardo others task should I take care for this? 

Thank you
Michela
From: Michela Sainato 
Sent: Thursday, August 9, 2018 1:26 PM
To: Krishna Nithin Cheemalavagupalli <knithinc@microsoft.com>; Wassim Fayed <Wassim.Fayed@microsoft.com>; Vijay Tewari <Vijay.Tewari@microsoft.com>; Femila Anilkumar <femila@microsoft.com>; Matt Briggs <Matthew.Briggs@microsoft.com>; Marc van Eijk <Marc.van.Eijk@microsoft.com>
Cc: Azure Stack Customer Obsession <asco@microsoft.com>
Subject: RE: Azure Stack integration with Azure Gov release (8/13) 

@Marc van Eijk can you please help making those changes?  Asap would be nice if it is possible if @Krishna Nithin Cheemalavagupalli cannot. 
Please let me know

Michela 

From: Krishna Nithin Cheemalavagupalli 
Sent: Thursday, August 9, 2018 1:21 PM
To: Wassim Fayed <Wassim.Fayed@microsoft.com>; Vijay Tewari <Vijay.Tewari@microsoft.com>; Michela Sainato <Michela.Sainato@microsoft.com>; Femila Anilkumar <femila@microsoft.com>; Matt Briggs <Matthew.Briggs@microsoft.com>
Cc: Azure Stack Customer Obsession <asco@microsoft.com>
Subject: RE: Azure Stack integration with Azure Gov release (8/13) 

It won’t happen that quick if you are dependent on me making that change. 
Go ahead and verify if those changes are the only ones needed and submit a PR to the repo. 

From: Wassim Fayed 
Sent: Thursday, August 9, 2018 1:17 PM
To: Krishna Nithin Cheemalavagupalli <knithinc@microsoft.com>; Vijay Tewari <Vijay.Tewari@microsoft.com>; Michela Sainato <Michela.Sainato@microsoft.com>; Femila Anilkumar <femila@microsoft.com>; Matt Briggs <Matthew.Briggs@microsoft.com>
Cc: Azure Stack Customer Obsession <asco@microsoft.com>
Subject: RE: Azure Stack integration with Azure Gov release (8/13) 

The change needs to happen in three places in this script. See added text in yellow.
We are announcing GA on 8/13. It would be best if we can do this ASAP.
